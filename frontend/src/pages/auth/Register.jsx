...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-6">
      ...
      >
        <h1 className="text-4xl font-extrabold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400 text-center leading-snug">
          Register
        </h1>

        {error && <p className="text-red-400 mb-4 text-center">{error}</p>}

        <label className="block text-gray-300 mb-1 font-medium" htmlFor="name">
          Full Name
        </label>
        <input
          id="name"
